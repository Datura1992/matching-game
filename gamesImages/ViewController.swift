...
//  gamesImages
//
//  Created by Александра Иванова on 28.05.2023.
//
...
class ViewController: UIViewController {
    ...
    var images = ["bird","buket","butterfly","ciren", "flowerRomashka","rose", "sakura", "vasa", "bird","buket","butterfly","ciren", "flowerRomashka","rose", "sakura", "vasa"]
    ...
    @objc func startTime() {
        ...
        @objc func clear() {
            ...
            for i in 0...15 {
                if state[i] == 1 {
                    state[i] = 0
                    let button = view.viewWithTag(i + 1) as!UIButton; button.setBackgroundImage(nil, for: .normal)
                }
